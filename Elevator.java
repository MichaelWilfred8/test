...
//TODO : receive packet with format 
// 		 decode and current and destination floor  
...
int DesFloor;
boolean door = false;
String doneMag = "elevator arrived destination floor, close light"; 
byte  done[] = doneMag.getBytes();
public Elevator()
{
   try {
...
public void receiveAndEcho() throws IOException
{
   ...
   byte echomsg [] = outputStream.toByteArray( ); 
   sendPacket = new DatagramPacket(echomsg, echomsg.length,
